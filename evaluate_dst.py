...
def evaluate_from_json(d_true, d_pred):
    ...
    for i in range(len(d_true)):
        ...
        assert d_true[i]['dialogue_idx'] == d_pred[i]['dialogue_idx']
...
def evaluate_from_flat_list(d_true, d_pred):
    ...
    act_rec, act_prec, act_f1 = 0, 0, 0 #rec_prec_f1(
        # n_correct=c["n_correct_acts"], n_true=c["n_true_acts"], n_pred=c["n_pred_acts"]
    # )

    slot_rec, slot_prec, slot_f1 = 0, 0, 0 # rec_prec_f1(
    #     n_correct=c["n_correct_slots"],
    #     n_true=c["n_true_slots"],
    #     n_pred=c["n_pred_slots"],
    # )

    request_slot_rec, request_slot_prec, request_slot_f1 = 0, 0, 0 #rec_prec_f1(
    ...
    # Calculate std err
    act_f1_stderr = 0   # d_f1(c["n_true_acts"], c["n_pred_acts"], c["n_correct_acts"])
    slot_f1_stderr = 0  # d_f1(c["n_true_slots"], c["n_pred_slots"], c["n_correct_slots"])
    request_slot_f1_stderr = 0  # d_f1(
