...
parser.add_argument(
    '-patience','--patience', help='patience for early stopping', required=False, default=30, type=int)
parser.add_argument(
...
parser.add_argument(
    ...
    help='The input features to use in inference, default=["user_utterance", "dialogue_history"]',
    default='["user_utterance", "dialogue_history"]')
parser.add_argument(
    '--simmc2_max_turns', type=int,
    help='How many turns to include in the dialogue history. Give -1 to include all turns available',
    default=-1)
parser.add_argument(
    '--simmc2_load_tmp_results', action="store_true",
    help='Load tmp file so continue with previously achieved progress',
    default=False)
